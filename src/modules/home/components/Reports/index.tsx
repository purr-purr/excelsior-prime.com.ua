	...
	return (
		<SplitBlocks title="Інформація" titleType="heading" anchor="reports">
			...
			<Accordion title="Відповідальність страхового посередника">
				<p>
					Договір страхування відповідальності страхових посередників ще не укладено,
					у зв&#39;язку з тим, що ТОВ «СТРАХОВИЙ БРОКЕР «ЕКСЕЛЬСІОР ПРАЙМ» станом на
					сьогоднішній день не отримує страхові та/або перестрахові премії та
					страхові та/або перестрахові виплати від клієнтів та/або страховиків,
					та/або перестраховиків.
				</p>
			</Accordion>
